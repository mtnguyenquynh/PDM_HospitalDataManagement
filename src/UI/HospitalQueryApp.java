...
public class HospitalQueryApp extends JFrame {
    ...
    private void initComponents() {
        ...
        txtQuery.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) { txtQueryActionPerformed(evt); }
        });
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                    .addComponent(txtQuery, GroupLayout.PREFERRED_SIZE, 107, GroupLayout.PREFERRED_SIZE)
